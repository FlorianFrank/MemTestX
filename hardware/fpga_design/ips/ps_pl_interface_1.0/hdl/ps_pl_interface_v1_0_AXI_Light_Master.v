...
`timescale 1 ns / 1 ps
	...
	module ps_pl_interface_v1_0_AXI_Light_Master #
	(
	...
	(
		...
		input wire[7:0] nr_transactions_dynamic,
		
		input wire activate_axi_master,
		
		input wire [7:0] cmd_handler_state,
        input wire [7:0] cmd_handler_cmd
	);
	...
	parameter [1:0] IDLE = 2'b00, // This state initiates AXI4Lite transaction 
	 ...
	 assign master_state_machine = mst_exec_state; 
	...
	reg [TRANS_NUM_BITS : 0] write_index = 0;
	...
	//Modify these as desired for different address patterns.
	  ...
	  always @(posedge M_AXI_ACLK)                                  
	    ...
	    /** State machine sending, address, value and checksum **/
        localparam STATE_WRITE_DATA      = 2'h0;
        localparam STATE_WRITE_ADDRESS   = 2'h1;
        localparam STATE_WRITE_VALUE     = 2'h2;
        ...
        begin                                                     
            ...
            begin     
                 if(cmd_handler_cmd == START_MEASUREMENT) begin
               ...
               if(cmd_handler_cmd == STOP_MEASUREMENT) begin
                    // Handle different stages of write transaction
                    case (write_index)
                        // Data stage: Set axi_wdata to a specific value
                        STATE_WRITE_DATA: begin 
                ...
                if(cmd_handler_cmd == RETRIEVE_STATUS) begin
                    // Handle different stages of write transaction
                    case (write_index)
                        // Data stage: Set axi_wdata to a specific value
                        STATE_WRITE_DATA: begin 
                ...
                if(cmd_handler_cmd == RESET) begin
                    // Handle different stages of write transaction
                    case (write_index)
                        // Data stage: Set axi_wdata to a specific value
                        STATE_WRITE_DATA: begin 
	       ...
	       // state transition                                                          
	        case (mst_exec_state)                                                       
	          ...
	          // AXI transaction when init_txn_pulse is asserted 
	            if ( init_txn_pulse == 1'b1 && activate_axi_master == 1'b1)                                     
	              begin                                                                 
