    ...
    ******************"""
    ...
    def add_memory_instance(self, memory_dict: dict):
        try:
            ...
            logger.error(f"Failed to add memory instance: {e}")
    ...
    ******************"""
    ...
    def get_all_tables(self) -> None:
        ...
        try:
            ...
            logger.error(f"Failed to retrieve tables from the database: {e}")
            raise
    ...
    def clear_all_tables(self) -> None:
        ...
        try:
            ...
            logger.error(f"Failed to drop `{self._tables}` table: {e}")
            raise
    ...
    def query_all_memories(self) -> dict:
        ...
        try:
            ...
            logger.error(f"Failed to query the `memories` table: {e}")
            raise
    ...
    def get_timing_parameter(self, memory_type_name: str):
        try:
            ...
            logger.error(f"Failed to query the table: {e}")
            raise
