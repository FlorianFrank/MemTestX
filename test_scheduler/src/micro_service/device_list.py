...
from device_definitions import DeviceType, DeviceStatus, DeviceProtocol
from device_template import DeviceTemplate


#from devices.device_definitions import DeviceStatus, DeviceType, DeviceProtocol
#from model.devices.device_template.py import DeviceTemplate
