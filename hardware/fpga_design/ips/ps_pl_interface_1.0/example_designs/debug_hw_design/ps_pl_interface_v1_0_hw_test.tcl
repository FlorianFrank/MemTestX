# Runtime Tcl commands to interact with - ps_pl_interface_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/ps_pl_interface_v1_0_include.tcl
...
# Test: AXI_Light_Slave
# Create a write transaction at axi_light_slave_addr address
create_hw_axi_txn w_axi_light_slave_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_light_slave_addr -data $wdata_1
# Create a read transaction at axi_light_slave_addr address
create_hw_axi_txn r_axi_light_slave_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_light_slave_addr
# Initiate transactions
run_hw_axi r_axi_light_slave_addr
run_hw_axi w_axi_light_slave_addr
run_hw_axi r_axi_light_slave_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_axi_light_slave_addr]]
# Compare read data
if { $rdata_tmp == $wdata_1 } {
	puts "Data comparison test pass for - AXI_Light_Slave"
} else {
	puts "Data comparison test fail for - AXI_Light_Slave, expected-$wdata_1 actual-$rdata_tmp"
	inc ec
}
...
# Test: AXI_Light_Master
set wdata_axi_light_master [get_init_data 0]
create_hw_axi_txn w_axi_light_master_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_axi_light_master}
create_hw_axi_txn r_axi_light_master_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_axi_light_master_addr
run_hw_axi w_axi_light_master_addr
run_hw_axi r_axi_light_master_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_axi_light_master_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 1 0 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - AXI_Light_Master"
} else {
	puts "Data comparison test fail for - AXI_Light_Master, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}
